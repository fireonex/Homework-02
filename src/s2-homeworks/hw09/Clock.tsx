...
function Clock() {
    ...
    const stringTime = `${get2DigitsString(date.getHours())}:${get2DigitsString(date.getMinutes())}:${get2DigitsString(date.getSeconds())}` ||
        <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты

    const stringDate = `${get2DigitsString(date.getDate())}.${get2DigitsString(date.getMonth() + 1)}.${date.getFullYear()}` ||
